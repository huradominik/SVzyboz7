...
set_property PACKAGE_PIN K18        [get_ports "power_good_0"]
set_property IOSTANDARD LVCMOS33    [get_ports "power_good_0"]
#
#IO_L24P_T3_34 Sch=sw[1] SW 1
set_property PACKAGE_PIN P16        [get_ports "t_last_0"]
...
#
#Buttons
##IO_L12N_T1_MRCC_35 Sch=btn[0] DIG_SENR_SD1_PGD
set_property PACKAGE_PIN G15        [get_ports "gpio_sw_tri_i[0]"]
set_property IOSTANDARD LVCMOS33    [get_ports "gpio_sw_tri_i[0]"]
#
#IO_L24N_T3_34 Sch=btn[1] DIG_SENR_SD2_PGD
set_property PACKAGE_PIN P15        [get_ports "gpio_sw_tri_i[1]"]
set_property IOSTANDARD LVCMOS33    [get_ports "gpio_sw_tri_i[1]"]
#
#IO_L10P_T1_AD11P_35 Sch=btn[2] DIG_SEQ_PWRGD
set_property PACKAGE_PIN W13        [get_ports "gpio_sw_tri_i[2]"]
set_property IOSTANDARD LVCMOS33    [get_ports "gpio_sw_tri_i[2]"]
#
#IO_L7P_T1_34 Sch=btn[3] DIG_SEQ_DONE
set_property PACKAGE_PIN T16        [get_ports "gpio_sw_tri_i[3]"]
set_property IOSTANDARD LVCMOS33    [get_ports "gpio_sw_tri_i[3]"]
#
#IO_L7P_T1_34 Sch=btn[3] DIG_SEQ_FLT
set_property PACKAGE_PIN Y16        [get_ports "gpio_sw_tri_i[4]"]
set_property IOSTANDARD LVCMOS33    [get_ports "gpio_sw_tri_i[4]"]
#
##Switches
