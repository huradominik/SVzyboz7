...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_10 -L processing_system7_vip_v1_0_12 -L xil_defaultlib -L xlconcat_v2_1_4 -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L axi_lite_ipif_v3_0_4 -L interrupt_control_v3_1_4 -L axi_gpio_v2_0_26 -L dist_mem_gen_v8_0_13 -L lib_pkg_v1_0_2 -L lib_srl_fifo_v1_0_2 -L fifo_generator_v13_2_5 -L lib_fifo_v1_0_14 -L axi_quad_spi_v3_2_23 -L axi_timer_v2_0_26 -L generic_baseblocks_v2_1_0 -L axi_register_slice_v2_1_24 -L axi_data_fifo_v2_1_23 -L axi_crossbar_v2_1_25 -L axi_protocol_converter_v2_1_24 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot scaneye_trigger xil_defaultlib.scaneye_trigger xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim scaneye_trigger -key {Behavioral:sim_1:Functional:scaneye_trigger} -tclbatch cmd.tcl -protoinst "protoinst_files/scaneye_trigger.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb scaneye_trigger.wdb xsim.dir)
