...
HD_PWD='e:/viv/scaneye_trigger/scaneye_trigger.tmp/trigger_cmv_v2_1_project/TRIGGER_CMV_v2_1_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TRIGGER_CMV_v2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TRIGGER_CMV_v2_0.tcl
