...
################################################################
# This is a generated script based on design: scaneye_trigger
#
...
# source scaneye_trigger_script.tcl
...
set design_name scaneye_trigger
...
proc create_root_design { parentCell } {
  ...
  set spi_pmod [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:spi_rtl:1.0 spi_pmod ]


  # Create ports
  set CMV_CLK [ create_bd_port -dir O -type clk CMV_CLK ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {250000000} \
 ] $CMV_CLK
  set frame_req_0 [ create_bd_port -dir IO frame_req_0 ]
  set power_good_0 [ create_bd_port -dir I power_good_0 ]
  set sys_clock [ create_bd_port -dir I -type clk -freq_hz 125000000 sys_clock ]
  set_property -dict [ list \
   CONFIG.PHASE {0.000} \
 ] $sys_clock
  set t_last_0 [ create_bd_port -dir I t_last_0 ]
  ...
  # Create instance: XCMV_0, and set properties
  set XCMV_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:XCMV:1.1 XCMV_0 ]
  set_property -dict [ list \
   CONFIG.INITIALIZATION_DELAY_TICK {2000} \
   CONFIG.IS_TIMER_TRIGGER {false} \
   CONFIG.RESET_DELAY_TICK {1500} \
 ] $XCMV_0
...
0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet\
0#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#SD 0#SD 0#SD 0#SD\
0#SD 0#SD 0#GPIO#SD 0#UART 1#UART 1#GPIO#GPIO#Enet 0#Enet 0}\
  ...
  connect_bd_intf_net -intf_net SPI_SPI_0 [get_bd_intf_ports spi_pmod] [get_bd_intf_pins SPI/SPI_0]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins SPI/AXI_LITE] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins XCMV_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M03_AXI]
  ...
  connect_bd_net -net Net1 [get_bd_ports frame_req_0] [get_bd_pins XCMV_0/frame_req]
  connect_bd_net -net SPI_ip2intc_irpt [get_bd_pins SPI/ip2intc_irpt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net XCMV_0_irq [get_bd_pins XCMV_0/irq] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net XCMV_0_sys_res_n [get_bd_pins XCMV_0/sys_res_n] [get_bd_pins ila_0/probe0]
  connect_bd_net -net XCMV_0_t_exp1 [get_bd_pins XCMV_0/t_exp1] [get_bd_pins ila_0/probe1]
  connect_bd_net -net XCMV_0_t_exp2 [get_bd_pins XCMV_0/t_exp2] [get_bd_pins ila_0/probe2]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_ports CMV_CLK] [get_bd_pins clk_wiz_0/clk_out1]
  connect_bd_net -net power_good_0_1 [get_bd_ports power_good_0] [get_bd_pins XCMV_0/power_good]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins SPI/ext_spi_clk] [get_bd_pins SPI/s_axi_aclk] [get_bd_pins XCMV_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins clk_wiz_0/s_axi_aclk] [get_bd_pins ila_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins SPI/s_axi_aresetn] [get_bd_pins XCMV_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins clk_wiz_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net t_last_0_1 [get_bd_ports t_last_0] [get_bd_pins XCMV_0/t_last]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]

  # Create address segments
  assign_bd_address -offset 0x41E00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs SPI/AXI_LITE/Reg] -force
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs XCMV_0/S_AXI/S_AXI_reg] -force
