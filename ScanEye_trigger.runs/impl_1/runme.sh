...
HD_PWD='C:/Scanway/Vivado/ScanEye_trigger/ScanEye_trigger.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log scaneye_trigger_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source scaneye_trigger_wrapper.tcl -notrace
