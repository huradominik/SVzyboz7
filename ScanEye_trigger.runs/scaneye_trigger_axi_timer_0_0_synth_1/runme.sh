...
HD_PWD='C:/Scanway/Vivado/ScanEye_trigger/ScanEye_trigger.runs/scaneye_trigger_axi_timer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log scaneye_trigger_axi_timer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source scaneye_trigger_axi_timer_0_0.tcl
